...
BOT_SETTINGS = {
    'auth_timeout': 1200,  # 2 минуты в секундах для неавторизованных
    'data_directory': 'data',
...
MESSAGES = {
    ...
    'auth_required': "Пожалуйста, авторизуйтесь в боте в течении 20 минут @{} для получения доступа к группе. Используйте команду /start в ЛС с ботом. В боте нажмите кнопку ПОДЕЛИТЬСЯ КОНТАКТОМ, это необходимо чтобы исключить доступ к группе случайных пользователей.",
