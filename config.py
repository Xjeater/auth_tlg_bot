...
BOT_SETTINGS = {
    'auth_timeout': 120,  # 2 минуты в секундах для неавторизованных
    'data_directory': 'data',
...
MESSAGES = {
    ...
    'auth_required': "Пожалуйста, авторизуйтесь в боте @{} для получения доступа к группе. Используйте команду /start в ЛС с ботом.",
