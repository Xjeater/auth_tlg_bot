...
MESSAGES = {
    ...
    'auth_required': "Пожалуйста, перейдите по ссылке @{} для получения доступа к группе. В боте нажмите кнопку СТАРТ и потом ПОДЕЛИТЬСЯ КОНТАКТОМ в течении 60 минут, это необходимо чтобы исключить доступ к группе случайных пользователей.",
